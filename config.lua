...
Config.Stores = {
    ...
    [23] = {shopType = 'clothing', coords = vector3(4496.29, -4453.53, 4.37), width = 9, length = 9}, --Cayo
    [24] = {shopType = 'clothing', coords = vector3(1951.5, 3765.98, 32.6), width = 9, length = 9}, --Cayo
}

-- set isGang to true if the requiredJob is a gang
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(447.64, -996.13, 35.06), width = 2, length = 2, cameraLocation = vector4(447.62, -992.94, 35.06, 184.03)},
    [2] = {requiredJob = 'ambulance', isGang = false, coords = vector3(301.3860168457, -599.49761962891, 43.28409576416), width = 2, length = 2, cameraLocation = vector4(302.32867431641, -597.17468261719, 43.28409576416, 157.61126708984)}, -- Right double door in Hospital Map that is on QBCore GitHub
    [3] = {requiredJob = 'police', isGang = false, coords = vector3(443.25, -996.97, 35.06), width = 2, length = 2, cameraLocation = vector4(443.12, -993.33, 35.06, 181.5)},
